...
pr:
depends_on: [T-101, T-102, T-103, T-104, T-151, T-201, T-301, T-401]
---
...
4. Run both frontends (`npm run dev`) and eyeball: admin edits a section → public page shows it after reload.
