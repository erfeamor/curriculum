...
| [T-006](T-006-contract-section-ordering.md) | Contract: define ordering for the CV section collections | cv-project (meta) | in_review | tech-product-owner | — | [#23](https://github.com/erfeamor/curriculum/pull/23) |
...
| # | ID | Title | Repo | Status | Owner | Depends on | PR |
|---|----|-------|------|--------|-------|------------|----|
| 1 | [T-013](T-013-contract-bff-public-routing.md) | Contract: BFF public edge path + anonymous reads | cv-project (meta) | in_review | tech-product-owner | — | [#22](https://github.com/erfeamor/curriculum/pull/22) |
