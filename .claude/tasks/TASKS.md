...
| — | [T-204](T-204-bff-validate-person-id-param.md) | BFF: validate the person id before the upstream call — **adopts T-201's shared guard, does not write a second one**; **T-206 ✔ merged first (2026-08-27), so the guard it adopts is already length- and value-bounded** | cv-bff-node | todo | | T-202 ✔, **T-201 ✔** | |
