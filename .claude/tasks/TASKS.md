...
| [T-022](T-022-domain-service-origin-bypasses-cloudfront.md) | Domain service reachable on :8080 bypassing CloudFront; leaks OpenAPI spec | cv-infra | in_review (**applied + verified by request**) | infrastructure-engineer | — | [#20](https://github.com/erfeamor/cv-infra/pull/20) |
