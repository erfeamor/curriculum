...
- **Wave 1 (5 agents in parallel):** T-101, T-102, T-103, T-104, T-151 — fully independent; the four API tasks touch disjoint packages, so PRs won't conflict except trivially.
  - ~~**Status as of 2026-08-09:** T-101 is **merged**… T-102/T-103/T-104 reached **H1 and stopped**… T-151 never started.~~ **Superseded 2026-08-20.** **Status as of 2026-08-20:** T-101 (`09282ed`) and T-102 (`42abe91`) are **merged**. **Wave 1 is now T-103, T-104 and T-151.** T-103/T-104 still hold complete, ratified H1 checkpoints from 2026-08-04 and no code — **start them at implementation, not refinement**, exactly as T-102 was and to the same effect. T-151 never started. Both API tasks now additionally carry the [T-107](T-107-post-id-cross-person-write.md) guard in their DoR, with the instruction to confirm the test fails first.
