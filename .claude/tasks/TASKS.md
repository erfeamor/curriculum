...
| [T-019](T-019-ci-host-on-demand.md) | Stop paying for an idle CI host: start on demand, stop when quiet | cv-infra | done (**merged, applied, webhooks re-pointed**; awaiting one real push — see sweep 2026-08-20) | infrastructure-engineer | — | [#17](https://github.com/erfeamor/cv-infra/pull/17) |
...
| [T-024](T-024-contract-skill-assignment-put-shape.md) | Contract: split the skill-assignment PUT's request body from its response | cv-project (meta) | in_review | tech-product-owner | — | [#41](https://github.com/erfeamor/curriculum/pull/41) |
