...
checkpoint:
  ...
  repo: cv-domain-service
  branch: feat/education-resource
  worktree: none      # CLEARED at close-out 2026-08-22 (retroactively). It WAS /home/erfeamor/work/cvdl-worktrees/T-102; the directory was removed by the 2026-08-20 sweep. T-028's generator refuses on a closed task that still declares a path -- verified refusing on this task before the fix.
  pr:
