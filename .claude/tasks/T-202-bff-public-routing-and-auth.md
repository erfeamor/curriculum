...
checkpoint:
  ...
  security_review_outcome: done   # was a second `security_review:`; RENAMED 2026-08-22 -- being last it shadowed the boolean above with a THIRD vocabulary for that key, after the 2026-08-17 sweep normalized `required`/`true` down to one. infrastructure-engineer, adversarial: no critical, no blocking.
